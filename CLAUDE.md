...
|---|---|---|
| `public/logo.webp` | Lockup completo: mascota + wordmark "DevPathlles" | Cabeceras, hero de la landing (spec 05 `landing`), README, cabecera de `/shared/[slug]` (spec 15 `path-sharing`) |
| `public/og-logo.png` | El mismo lockup en PNG, 360 × 128 | Solo la tarjeta OG de `/shared/[slug]` (spec 15): `ImageResponse` no decodifica WebP |
